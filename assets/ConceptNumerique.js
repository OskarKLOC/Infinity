                            ...
                            <div className="card-body d-flex flex-column justify-content-between">
                                <div>
                                    ...
                                    <ul className="my-5">
                                        ...
                                        <li><img src="../../img/icones/stockage.svg"/> 1 Go de d'espace de stockage sécurisé</li>
                                    </ul>
                                    <h4 className=" text-center my-5">3.99€ / mois</h4>
                                </div>
                            ...
                            <div className="card-body d-flex flex-column justify-content-between">
                                <div>
                                    ...
                                    <ul className="my-5">
                                        ...
                                        <li><img src="../../img/icones/cloudupload.svg" alt=""/> 5 Go d'espace de stockage sécurisé</li>
                                    ...
                                    <h4 className=" text-center my-5">5.99€ / mois</h4>
                                </div>
                                <div className="text-center">
                                    <a href="/inscription" className="btn btn-secondary">Choisir</a>
                                </div>
                            ...
                            <div className="card-body d-flex flex-column justify-content-between">
                                <div>
                                    ...
                                    <ul className="my-5">
                                        ...
                                        <li><img src="../../img/icones/cloudupload.svg" alt=""/> 15 Go d'espace de stockage sécurisé</li>
